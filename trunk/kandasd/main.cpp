...
{
    KAboutData about("kandasd", "kandas", ki18nc("The application's name", "KaNDASd"), Kandas::Daemon::DaemonVersionRaw, ki18n(description), KAboutData::License_GPL, ki18n("(C) 2008 Stefan Majewsky"), KLocalizedString(), "http://code.google.com/p/kandas/", "majewsky@gmx.net");
